...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function(){
            const table = initDataTable('#payments-table', '<?php echo e(route('admin.payments.index')); ?>' + '/data', [
                { data: 0 },
                { data: 1 },
                { data: 2 },
                { data: 3 },
            ...
            $('#payments-table').on('click','.btn-show', function(){
                let id = $(this).data('id');
                $.get('<?php echo e(url('admin/payments')); ?>/'+id, function(res){
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\PROJEK APLIKASI\delivery\resources\views/admin/payments/index.blade.php ENDPATH**/ ?>