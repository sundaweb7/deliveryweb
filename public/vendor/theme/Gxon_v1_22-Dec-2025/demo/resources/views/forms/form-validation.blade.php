...
<div class="app-page-head">
	<h1 class="app-page-title">Form validation</h1>
...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				<h6 class="card-title">Custom styles</h6>
			</div>
			<div class="card-body">
	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				<h6 class="card-title">Browser defaults</h6>
			</div>
			<div class="card-body">
				<form class="row g-3">
					@csrf
	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				<h6 class="card-title">Server side</h6>
			</div>
			<div class="card-body">
				<form class="row g-3">
					@csrf
	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				<h6 class="card-title">Supported elements</h6>
			</div>
			<div class="card-body">
				<form class="was-validated">
					...
					<div class="mb-3">
						<button class="btn btn-primary waves-effect waves-light" type="submit" disabled>Submit form</button>
					</div>
				</form>
			</div>
		</div>
