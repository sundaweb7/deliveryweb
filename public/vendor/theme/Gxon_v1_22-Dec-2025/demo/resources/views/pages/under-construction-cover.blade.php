...
<div class="maintenance-cover-wrapper">
	<div class="row g-0">
		...
		<div class="col-lg-6">
			<div class="maintenance-cover" style="background-image: url({{ asset('assets/images/maintenance/cover-bg.png') }});">
				<img src="{{ asset('assets/images/maintenance/vector1.png') }}" alt="" class="img-fluid cover-img">
			</div>
		</div>
	</div>
</div>
